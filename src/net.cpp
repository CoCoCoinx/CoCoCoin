...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CoCoCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"65.49.54.14","65.49.54.14"},
    {"23.244.178.116","23.244.178.116"},
    {"65.49.54.203","65.49.54.203"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CoCoCoin is probably already running."), addrBind.ToString().c_str());
        else
